...
def culc_aypos_gain(ip_addresses, prop_gain_file_path = 'C:\\Users\\B_L_C\\Desktop\\Real_Scenario_Data_Generator\\gain_output.csv',
    ...
    # when compute3 and compute4 open,
    # power = df['compute3'] +
    do_once = True
...
def runn_gain(num=15, computes_open=None):
    ...
    with open(f'C:\\Users\\B_L_C\\Desktop\\Real_Scenario_Data_Generator\\reg_gain{num}.json', 'w') as json_file: # !  !!!
        json.dump(aypos_dict, json_file, indent=4)
    return aypos_dict
