...
def get_sensor_data():
    ...
    # Retrieve voltages
    voltage_1_12 = float(spl_int(snmp_get("iso.3.6.1.4.1.30966.5.1.1.3.5.0"))) # float(spl(snmp_get("iso.3.6.1.4.1.30966.5.1.1.3.5.0")))
    voltage_13_24 = voltage_1_12
    # Retrieve currents
    curr_compute1 = float(spl(snmp_get("iso.3.6.1.4.1.30966.5.1.1.10.5.0")))  # Socket 5
    curr_compute2 = float(spl(snmp_get("iso.3.6.1.4.1.30966.5.1.1.10.4.0")))  # Socket 4
    curr_compute3 = float(spl(snmp_get("iso.3.6.1.4.1.30966.5.1.1.10.9.0")))  # Socket 9
    curr_compute4 = float(spl(snmp_get("iso.3.6.1.4.1.30966.5.1.1.10.1.0")))  # Socket 1

    # Retrieve energies
    energy_1_12 = float(spl_int(snmp_get("iso.3.6.1.4.1.30966.5.1.1.3.9.0"))) # float(spl(snmp_get("iso.3.6.1.4.1.30966.5.1.1.3.9.0")))
    ...
    pf_compute1 =  subprocess.Popen([r"snmpget","-v1","-c","public",pdu_ip,"iso.3.6.1.4.1.30966.5.1.1.3.2.0"], stdout=subprocess.PIPE).communicate()[0].decode('utf-8')
